...
#include "../include/pub_world_state.h"
...
GZ_REGISTER_DYNAMIC_CONTROLLER("pub_world_state", GazeboRosPubWorldState);
...
void GazeboRosPubWorldState::LoadChild(XMLConfigNode *node)
{
  ...
  ros::AdvertiseOptions ao = ros::AdvertiseOptions::create<gazebo_msgs::WorldState>(
    this->topicName,1,
